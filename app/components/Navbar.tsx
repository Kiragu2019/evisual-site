    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${
          isScrolled 
            ? "bg-white/90 dark:bg-[#1a1c1e]/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 py-3" 
            : "bg-transparent py-6"
        }`}
      >
        <nav className="max-w-[1440px] mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex-1 flex justify-end items-center gap-4">
            <a
              ...
              className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20ba5a] text-white px-5 py-2.5 rounded-full text-[14px] font-semibold transition-all shadow-lg shadow-green-500/20 active:scale-95"
            >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[90] bg-white dark:bg-[#1a1c1e] pt-28 px-8 md:hidden flex flex-col items-center text-center"
          >
